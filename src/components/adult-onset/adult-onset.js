...
export default class AdultOnset extends React.Component {
  ...
  render() {
    return (
      ...
      //     <div class="route-row-1 m-3 d-flex flex-column justify-content-evenly flex-wrap">
      ...
      //       </div>
      //     </div>
      //     <div class="route-row-2 d-flex flex-row justify-content-evenly flex-wrap">
      //       <div class="d-flex flex-column">
      //         <h4 class="row-2-heading">Carrier Risk</h4>
      //         <div class="row-2-card m-4">
