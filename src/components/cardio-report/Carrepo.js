          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                FXN*, GLA, LAMP2, MYBPC3, MYH6, MYH7, MYL2, MYL3, MYLK2, MYO6,
                MYOM1, MYOZ2, NDUFAF1*, NEXN, OBSCN*, PDLIM3, PLN, PRKAG2*,
                RAF1, SLC25A4, SRI, TCAP, TNNC1, TNNI3, TNNT2, TPM1, TTN, TTR{' '}
              </td>
              <td>
                {/* BRCA1{' '} */}
                {/* <img
                  ...
                  onClick={openPanel} */}
                {/* /> */}
                <button className="tnnc1">TNNC1</button>
              </td>
            ...
            <tr>
              ...
              <td>
                ABCC9, ACE, ACTC1, ACTN2*, ANKRD1, BAG3, BMP10, CHRM2, CRYAB,
                CSRP3, DES*, DMD, DNAJC19, DSG2, DSP, EMD*, EYA4, FKTN, FLT1,
                FOXD4*, ILK, LAMA2, LAMA4, LAMP2, LDB3*, LMNA*, MURC*, MYBPC3,
                MYH6, MYH7, MYPN, NEBL, NEXN, PDLIM3, PLN, PSEN1, PSEN2, RBM20,
                SCN5A*, SDHA*, SGCD, SYNE1, TAZ, TCAP, TCF21, TMPO, TNNC1,
                TNNI3, TNNT2, TPM1, TTN, TTR, TXNRD2, VCL, VPS13A
              </td>
              <td>
                {/* BRCA1{' '}
                <img
           ...
           BRCA1
            ...
            <tr>
              ...
              <td>
                DES*, DSC2, DSG2, DSP, JUP, PKP2, RYR2, TGFB3, TMEM43, TTN
              </td>
              <td></td>
              <td className="no-text">NO</td>
            </tr>
            ...
            <tr>
              ...
              <td>
                AKAP9, ANK2, CACNA1C, CAV3*, KCNE1, KCNE2*, KCNH2*, KCNJ2,
                KCNJ5, KCNQ1*, SCN4B, SCN5A*
              </td>
              <td></td>
              <td className="no-text">NO</td>
            </tr>
            <tr>
              ...
              <td>
                ABCC9, ANK3, CACNA1C, CACNA1D, CACNA2D1, CACNB2, GPD1L*, KCND3,
                KCNE3, KCNH2*, KCNJ8, RANGRF, SCN1B, SCN2B, SCN3B, SCN5A*, TRPM4
              </td>
              <td></td>
              <td className="no-text">NO</td>
            </tr>
            ...
            <tr>
              ...
              <td>
                AKAP9, ANK2, CACNA1C, CACNA2D1, CACNB2, CALM1, CASQ2, CAV3*,
                DES*, DSC2, DSG2, DSP, GPD1L*, JUP, KCNE1, KCNE2*, KCNE3,
                KCNH2*, KCNJ2, KCNJ8, KCNQ1*, LMNA*, PKP2, RYR2, SCN1B, SCN3B,
                SCN4B, SCN5A*, TMEM43, TRDN
              </td>
              <td></td>
              <td className="no-text">NO</td>
            </tr>
            <tr>
              ...
              <td>
                AKAP9, ANK2, CACNA1C, CACNA2D1, CACNB2, CASQ2, CAV3*, DES*,
                DSC2, DSG2, DSP, GPD1L*, JUP, KCNE1, KCNE2*, KCNE3, KCNH2*,
                KCNJ2, KCNJ8, KCNQ1*, LMNA*, PKP2, RYR2, SCN1B, SCN3B, SCN4B,
                SCN5A*, TMEM43
              </td>
              <td></td>
              <td className="no-text">NO</td>
            ...
            <tr>
              ...
              <td>
                ACTC1, CAV3*, GLA, LAMP2, MYBPC3, MYH7, MYL2, MYL3, NKX2-5*,
                PRKAG2*, TNNC1, TNNI3, TNNT2, TPM1, TTR
              </td>
              <td></td>
              <td className="no-text">NO</td>
            </tr>
            <tr>
              ...
              <td>
                ABCC9, EMD*, GJA5*, KCNA5, KCNE2*, KCNE3, KCNH2*, KCNJ2, KCNJ5,
